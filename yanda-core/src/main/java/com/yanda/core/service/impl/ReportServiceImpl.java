...
import com.yanda.core.entity.ReportInfo;
import com.yanda.core.entity.WebClassifyInfo;
import com.yanda.core.mapper.ReportMapper;
import com.yanda.core.service.ClassifyService;
import com.yanda.core.service.ReportService;
...
public class ReportServiceImpl implements ReportService {
	...
	public ReportInfo getClassifyMvCount() {
		...
		// 所有一级分类数据
		List<WebClassifyInfo> classifyInfos = classifyService.findListByType(1);
		// 组装成前台需要的结果对象
