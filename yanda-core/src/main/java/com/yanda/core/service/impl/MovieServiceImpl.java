...
import com.yanda.core.entity.generated.MovieInfo.Col;
...
public class MovieServiceImpl extends BaseServiceImpl<MovieInfoMapper, MovieInfo, Long> implements MovieService {
	...
	public List<ClassifyInfo> findClassifyListByIds(List<Integer> classifyIds) {
		...
		return classifyInfoMapper.selectByExampleSelective(example, com.yanda.core.entity.generated.ClassifyInfo.Col.classifyId, com.yanda.core.entity.generated.ClassifyInfo.Col.classifyName);
	}
