...
public class TokenValidAop {
	...
	@Pointcut("execution(* com.yanda.wx.controller..*.*(..)) && !execution(* com.yanda.wx.controller.UserController.*(..))"
			+ "&& !execution(* com.yanda.wx.controller.ClassifyController.*(..))"
			+ "&& !execution(* com.yanda.wx.controller.MovieController.getClassify*(..))")
